...
TRANSLATIONS = {
    "ko": {
        ...
        "current_skin": "현재 스킨", "bounce_stiffness": "모션 튀는 정도 (탄성)",
        ...
        "using_default_sound": "기본 사운드 사용 중", "select_sound": "사운드 선택:",
    ...
    "en": {
        "settings_title": "morningmeal_Compet - Settings", "tab_general": "⚙️ General", "tab_sound": "🎵 Sound", "tab_pets": "🐾 Pets", "tab_skin": "🎨 Skin",
        ...
        "current_skin": "Current Skin", "bounce_stiffness": "Bounce Stiffness",
        ...
        "using_default_sound": "Using Default Sound", "select_sound": "Select Sound:",
    ...
    "ja": {
        ...
        "current_skin": "現在のスキン", "bounce_stiffness": "バウンドの硬さ",
        "save_apply": "💾 保存して適用",
        ...
        "using_default_sound": "デフォルトサウンド使用中", "select_sound": "サウンド選択:",
    ...
    "zh_CN": {
        ...
        "current_skin": "当前皮肤", "bounce_stiffness": "弹跳硬度",
        "save_apply": "💾 保存并应用",
        ...
        "using_default_sound": "使用默认声音", "select_sound": "选择声音:",
    ...
    "zh_TW": {
        ...
        "current_skin": "當前皮膚", "bounce_stiffness": "彈跳硬度",
        "save_apply": "💾 保存並應用",
        ...
        "using_default_sound": "使用默認聲音", "select_sound": "選擇聲音:",
